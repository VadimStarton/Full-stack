...
<body>
    ...
    <div class="forms">
        <form action="http://localhost/full-stack/back-end/db/store.php" method="post">
            <h2>Plant a tree</h2>
        ...
        <form action="http://localhost/full-stack/back-end/db/destroy.php" method="post">
            <h2>Cut a tree</h2>
            <input type="text" name="id" placeholder="Id">
            <button type="submit">Cut Tree</button>
        </form>
        <form action="http://localhost/full-stack/back-end/db/update.php" method="post">
            <h2>Grow a tree</h2>
            <input type="text" name="id" placeholder="Id">
            <input type="text" name="height" placeholder="Height">
